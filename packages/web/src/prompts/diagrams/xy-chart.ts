...
11. 日本語などASCII以外の文字を含むラベルは必ず二重引用符で囲んでください（例: x-axis ["1月", "2月"]）。囲まないと描画に失敗します。
12. 軸の範囲は必ず具体的な数値で記述してください（例: y-axis "ラベル" 0 --> 100）。min や max といった語をそのまま書かないでください。範囲が決められない場合は範囲を省略し y-axis "ラベル" だけを記述してください。
